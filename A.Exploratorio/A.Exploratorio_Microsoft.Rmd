---
title: "Analisis Exploratorio Microsoft"
...
precios <- as.numeric(data$MSFT.Close)
...
ggplot(df, aes(x = date, y = close)) +
  ...
  labs(title = "Precio de Cierre de Microsoft (MSFT)",
...
df_boxplot <- data.frame(date = index(MSFT),
