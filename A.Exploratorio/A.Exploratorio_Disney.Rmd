---
title: "Analisis Exploratorio Disney"
...
precios <- as.numeric(data$DIS.Close)
...
ggplot(df, aes(x = date, y = close)) +
  ...
  labs(title = "Precio de Cierre de Disney (DIS)",
...
df_boxplot <- data.frame(date = index(DIS),
                 close = as.numeric(DIS[, "DIS.Close"])) %>%
