...
getSymbols("TSLA", from = "2011-01-01", to = "2025-01-01", auto.assign = TRUE)

# TSLA está en un xts, lo convertimos a data.frame
df <- data.frame(Date = index(TSLA), Close = as.numeric(Cl(TSLA)))
