...
getSymbols("KO", from = "2000-01-01", to = "2025-01-01", auto.assign = TRUE)

# KO está en un xts, lo convertimos a data.frame
df <- data.frame(Date = index(KO), Close = as.numeric(Cl(KO)))
