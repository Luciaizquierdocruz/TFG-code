...
df <- data.frame(ds = index(MSFT), y = as.numeric(MSFT$MSFT.Close))
```
...
ggplot() +
  ...
  labs(title = "Precio de cierre de Microsoft: predicción vs real (modelo m1)",
       x = "Fecha",
       y = "Precio",
       color = "") +
  theme_minimal() +
...
ggplot() +
  ...
  labs(title = "Precio de cierre de Microsoft: predicción vs real (modelo m2)",
       x = "Fecha",
       y = "Precio",
       color = "") +
  theme_minimal() +
...
ggplot() +
  ...
  labs(title = "Precio de cierre de Microsoft: predicción vs real (modelo m3)",
       x = "Fecha",
       y = "Precio",
       color = "") +
  theme_minimal() +
