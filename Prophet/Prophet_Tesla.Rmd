...
df <- data.frame(ds = index(TSLA), y = as.numeric(TSLA$TSLA.Close))
```
...
ggplot() +
  ...
  labs(title = "Precio de cierre de Tesla: predicción vs real (modelo m1)",
       x = "Fecha",
       y = "Precio",
       color = "") +
  theme_minimal() +
...
ggplot() +
  ...
  labs(title = "Precio de cierre de Tesla: predicción vs real (modelo m2)",
       x = "Fecha",
       y = "Precio",
       color = "") +
  theme_minimal() +
...
ggplot() +
  ...
  labs(title = "Precio de cierre de Tesla: predicción vs real (modelo m3)",
       x = "Fecha",
       y = "Precio",
       color = "") +
  theme_minimal() +
